...
static void_fnp spec_fn_table[] = {
	do_null,	enter,		show_ptregs,	do_null, //xby_debug, show_mem,
	do_null, /*show_state,*/send_intr,	lastcons,	caps_toggle,
...
__maybe_unused static void keyboard_interrupt(int irq, struct pt_regs *regs)
{
 ...
 * prevention later on.
 */
__maybe_unused static void kbd_bh(void * unused)
{
